...
func parseInt32(str string)(int32, error) {
    i,
    err: = strconv.ParseInt(str, 10, 32)
    if err != nil {
...
func main() {
    ...
    // Create BlockchainServiceClient
        blockchainClient,
    err: = v1clients.NewBlockchainServiceClient(ctx, authOpt)
    if err != nil {
    ...
    mpcKeyClient,
    err: = v1clients.NewMPCKeyServiceClient(ctx, authOpt)
    if err != nil {
        log.Fatalf("Error instantiating MPCKeyServiceClient: %v", err)
    }

    // Create MPCTransactionServiceClient
    mpcTransactionClient,
    err: = v1clients.NewMPCTransactionServiceClient(ctx, authOpt)
    if err != nil {
    ...
    mpcWalletClient,
    err: = v1clients.NewMPCWalletServiceClient(ctx, authOpt)
    if err != nil {
    ...
    poolClient,
    err: = v1clients.NewPoolServiceClient(ctx, authOpt)
    if err != nil {
    ...
    protocolClient,
    err: = v1clients.NewProtocolServiceClient(ctx, authOpt)
    if err != nil {
    ...
    // Blockchain API - ListNetworks (GET)
        ...
        pageSize,
        err: = parseInt32(c.DefaultQuery("pageSize", "50"))
        if err != nil {
        ...
        pageToken: = c.Query("pageToken")
            ...
            networksIter: = blockchainClient.ListNetworks(context.Background(), & blockchain.ListNetworksRequest {
            PageSize: pageSize,
            PageToken: pageToken
        })
    ...
    // Blockchain API - GetNetwork (GET)
        ...
        networkName: = "networks/" + networkId
            ...
            network,
        err: = blockchainClient.GetNetwork(context.Background(), & blockchain.GetNetworkRequest {
            Name: networkName
        })
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
    ...
    // Blockchain API - ListAssets (GET)
        ...
        filter: = c.Query("filter")
            ...
            assetsIter: = blockchainClient.ListAssets(context.Background(), & blockchain.ListAssetsRequest {
            Parent: networkName,
            PageSize: pageSize,
            PageToken: pageToken,
            Filter: filter
    ...
    // Blockchain API - GetAsset (GET)
        ...
        asset,
        err: = blockchainClient.GetAsset(context.Background(), & blockchain.GetAssetRequest {
            Name: assetName
        })
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
    ...
    // MPC Keys API - GetMPCKey (GET)
        ...
        mpcKeyName: = "pools/" + poolId + "/deviceGroups/" + deviceGroupId + "/mpcKeys/" + mpcKeyId
            ...
            mpcKey,
        err: = mpcKeyClient.GetMPCKey(context.Background(), & mpcKeys.GetMPCKeyRequest {
            Name: mpcKeyName
        })
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
    ...
    // MPC Keys API - GetDevice (GET)
        ...
        deviceName: = "devices/" + deviceId
            ...
            device,
        err: = mpcKeyClient.GetDevice(context.Background(), & mpcKeys.GetDeviceRequest {
            Name: deviceName
        })
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
    ...
    // MPC Keys API - GetDeviceGroup (GET)
        ...
        deviceGroupName: = "pools/" + poolId + "/deviceGroups/" + deviceGroupId
            ...
            deviceGroup,
        err: = mpcKeyClient.GetDeviceGroup(context.Background(), & mpcKeys.GetDeviceGroupRequest {
    ...
    // MPC Keys API - ListMPCOperations (GET)
        ...
        deviceGroupName: = "pools/" + poolId + "/deviceGroups/" + deviceGroupId
            ...
            mpcOperations,
        err: = mpcKeyClient.ListMPCOperations(context.Background(), & mpcKeys.ListMPCOperationsRequest {
        ...
        mpcOperationsJSON,
        err: = json.Marshal(mpcOperations)
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
                "error": err.Error()
            })
    ...
    // MPC Keys API - RegisterDevice (POST)
        ...
        if err: = c.BindJSON( & registerDeviceReq);
        err != nil {
            c.JSON(http.StatusBadRequest, gin.H {
                "error": err.Error()
            })
    ...
    // MPC Keys API - CreateMPCKey (POST)
        ...
        createMpcKeyReq: = & mpcKeys.CreateMPCKeyRequest {
            Parent: deviceGroupName,
            MpcKey: mpcKey,
            RequestId: requestId
        }
        response,
        err: = mpcKeyClient.CreateMPCKey(ctx, createMpcKeyReq)
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
                "error": err.Error()
            })
    ...
    // MPC Keys API - CreateSignature (POST)
        ...
        createSignatureReq: = & mpcKeys.CreateSignatureRequest {
            Parent: mpcKeyName,
            Signature: signature,
            RequestId: requestId
        }
        response,
        err: = mpcKeyClient.CreateSignature(ctx, createSignatureReq)
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
                "error": err.Error()
            })
    ...
    // MPC Keys API - CreateDeviceGroup (POST)
        ...
        createDeviceGroupReq: = & mpcKeys.CreateDeviceGroupRequest {
            Parent: mpcKeyName,
        ...
        response,
        err: = mpcKeyClient.CreateDeviceGroup(ctx, createDeviceGroupReq)
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
                "error": err.Error()
            })
    ...
    // MPC Transactions API - GetMPCTransaction (GET)
        ...
        mpcTransactionId: = c.Param("mpcTransactionId")
            ...
            mpcTx,
        err: = mpcTransactionClient.GetMPCTransaction(context.Background(), & mpcTransactions.GetMPCTransactionRequest {
    ...
    // MPC Transactions API - ListMPCTransactions (GET)
        ...
        pageToken: = c.Query("pageToken")
            ...
            mpxTxsIter: = mpcTransactionClient.ListMPCTransactions(context.Background(), & mpcTransactions.ListMPCTransactionsRequest {
            Parent: mpcWalletName,
            PageSize: pageSize,
            PageToken: pageToken
        })
    ...
    // MPC Transactions API - CreateMPCTransaction (POST)
        ...
        createMpcTxReq: = & mpcTransactions.CreateMPCTransactionRequest {
            Parent: mpcWalletName,
            MpcTransaction: requestBody.MpcTransaction,
            Input: requestBody.Input,
            OverrideNonce: requestBody.OverrideNonce,
            RequestId: requestBody.RequestId
        }
        response,
        err: = mpcTransactionClient.CreateMPCTransaction(ctx, createMpcTxReq)
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
                "error": err.Error()
            })
    ...
    // MPC Wallets API - GetMPCWallet (GET)
        ...
        mpcWalletId: = c.Param("mpcWalletId")
            ...
            wallet,
        err: = mpcWalletClient.GetMPCWallet(context.Background(), & mpcWallet.GetMPCWalletRequest {
            Name: mpcWalletName
        })
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
    ...
    // MPC Wallets API - ListMPCWallets (GET)
        ...
        pageToken: = c.Query("pageToken")
            ...
            walletsIter: = mpcWalletClient.ListMPCWallets(context.Background(), & mpcWallet.ListMPCWalletsRequest {
            Parent: poolName,
            PageSize: pageSize,
            PageToken: pageToken
        })
    ...
    // MPC Wallets API - GetAddress (GET)
        ...
        networkName: = "networks/" + networkId + "/addresses/" + addressId
            ...
            address,
        err: = mpcWalletClient.GetAddress(context.Background(), & mpcWallet.GetAddressRequest {
            Name: networkName
        })
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
    ...
    // MPC Wallets API - ListAddresses (GET)
        ...
        wallet: = c.Query("mpcWallet")
            ...
            addressesIter: = mpcWalletClient.ListAddresses(context.Background(), & mpcWallet.ListAddressesRequest {
            Parent: networkName,
            MpcWallet: wallet,
            PageSize: pageSize,
            PageToken: pageToken
    ...
    // MPC Wallets API - ListBalances (GET)
        ...
        pageToken: = c.Query("pageToken")
            ...
            balancesIter: = mpcWalletClient.ListBalances(context.Background(), & mpcWallet.ListBalancesRequest {
            Parent: addressName,
            PageSize: pageSize,
            PageToken: pageToken
        })
    ...
    // MPC Wallets API - CreateMPCWallet (POST)
        ...
        createMpcWalletReq: = & mpcWallet.CreateMPCWalletRequest {
            Parent: poolName,
            MpcWallet: wallet,
            Device: device,
            RequestId: requestId
        ...
        response,
        err: = mpcWalletClient.CreateMPCWallet(ctx, createMpcWalletReq)
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
                "error": err.Error()
            })
    ...
    // MPC Wallets API - GenerateAddress (POST)
        ...
        generateAddressReq: = & mpcWallet.GenerateAddressRequest {
            MpcWallet: mpcWalletName,
            Network: requestBody.Network,
            RequestId: requestBody.RequestId
        }
        response,
        err: = mpcWalletClient.GenerateAddress(ctx, generateAddressReq)
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
                "error": err.Error()
            })
    ...
    // Pools API - GetPool (GET)
        ...
        poolName: = "pools/" + poolId
            ...
            pool,
        err: = poolClient.GetPool(context.Background(), & pools.GetPoolRequest {
            Name: poolName
        })
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
    ...
    // Pools API - ListPools (GET)
        ...
        pageToken: = c.Query("pageToken")
            ...
            poolsIter: = poolClient.ListPools(context.Background(), & pools.ListPoolsRequest {
            PageSize: pageSize,
            PageToken: pageToken
        })
    ...
    // Pools API - CreatePool (POST)
        ...
        createPoolReq: = & pools.CreatePoolRequest {
            PoolId: poolId,
            Pool: pool
        }
        response,
        err: = poolClient.CreatePool(ctx, createPoolReq)
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
                "error": err.Error()
            })
    ...
    // Protocols API - BroadcastTransaction (POST)
        ...
        broadcastTxReq: = & protocols.BroadcastTransactionRequest {
            Network: networkName,
            Transaction: transaction
        }
        response,
        err: = protocolClient.BroadcastTransaction(ctx, broadcastTxReq)
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
                "error": err.Error()
            })
    ...
    // Protocols API - ConstructTransaction (POST)
        ...
        constructTxReq: = & protocols.ConstructTransactionRequest {
            Network: networkName,
            Input: input
        }
        response,
        err: = protocolClient.ConstructTransaction(ctx, constructTxReq)
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
                "error": err.Error()
            })
    ...
    // Protocols API - ConstructTransferTransaction (POST)
        ...
        constructTransferTxReq: = & protocols.ConstructTransferTransactionRequest {
            Network: networkName,
        ...
        response,
        err: = protocolClient.ConstructTransferTransaction(ctx, constructTransferTxReq)
        if err != nil {
            c.JSON(http.StatusInternalServerError, gin.H {
                "error": err.Error()
            })
